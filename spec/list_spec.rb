...
RSpec.describe LinkedList do
  ...
  xit "has a method to add next node" do
    list_1 = LinkedList.new
    list_1.append("doop")
    expect(list_1.head.data).to eq ("doop")
  end

  xit "has a next node value of nil" do
    list_1 = LinkedList.new
    list_1.append("doop")
    expect(list_1.head.next_node).to eq nil
  end

  xit "has a counter that counts 0" do
    list_1 = LinkedList.new
    expect(list_1.count).to eq (0)
  end

  xit "has a counter that counts to 1" do
    list_1 = LinkedList.new
    list_1.append("doop")
    expect(list_1.count).to eq (1)
  end

  xit "has a counter that counts to 2" do
    list_1 = LinkedList.new
    list_1.append("doop")
    list_1.append("ploop")
  ...
  xit "has a counter that counts to 3" do
    list_1 = LinkedList.new
    list_1.append("doop")
    list_1.append("ploop")
    list_1.append("boop")
